    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      {activeTab === 'products' && (
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs">
            ...
            <div className="flex flex-wrap items-center gap-2 shrink-0">
              ...
              <button
                ...
                className="bg-purple-50 hover:bg-purple-100 text-purple-700 dark:bg-purple-950/30 dark:hover:bg-purple-900/40 dark:text-purple-300 font-bold px-3.5 py-2.5 rounded-xl text-xs flex items-center gap-2 border border-purple-200 dark:border-purple-800 transition-all cursor-pointer shrink-0 shadow-2xs"
                title="Add, rename or remove product categories"
              >
          ...
          {/* Admin Category Manager Dialogue Box Modal */}
          <AdminCategoryManagerModal
            isOpen={isCategoryModalOpen}
            onClose={() => setIsCategoryModalOpen(false)}
            onSelectCategory={(cat) => setCatalogCategoryFilter(cat)}
          />
          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xs">
            <div className="p-4 bg-slate-50 border-b border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                <button
                  onClick={() => setIsCategoryModalOpen(true)}
                  className="px-2.5 py-1.5 bg-slate-100 hover:bg-purple-50 text-purple-700 border border-slate-300 rounded-xl text-xs font-bold transition-colors flex items-center gap-1 shrink-0 cursor-pointer"
